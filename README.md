...
> **(Yeah the frontend is vibe-coded, didn't have enough time)**  
> **Look into dev branch for sketches / code**
...
| **100 µF capacitor**     | Stabilize Voltage         | VCC and GND before the LoRa Module        |
| **680 µF capacitor**     | Stabilize Voltage         | VCC and GND after the battery pack
